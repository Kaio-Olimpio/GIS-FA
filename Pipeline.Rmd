...
subtitle: "Theor Appl Genet (2024). https://doi.org/10.1007/s00122-017-3033-y"
author: "Saulo F. S. Chaves, Mauricio S. Araujo, Matheus D. Krause, Kaio O. G. Dias"
header-includes:
  - \usepackage{fancyhdr}
  - \pagestyle{fancy}
...
$$v_{k_j} = \frac{{\hat{\lambda}^{\star^2}_{k_j}d_k}}{\sum^K_{k=1}{\hat{\lambda}^{\star^2}_{k_j}d_k + \hat{\psi}_j}} \times 100$$ 
...
$$\texttt{Index}_i = \left[2 \times \frac{OP_i - \overline{OP}}{\sqrt{V(OP)}}\right] - \frac{RMSD_i - \overline{RMSD}}{\sqrt{V(RMSD)}}$$
